...
%                                                                   %
%___________________________________________________________________%
% function [fval,gbest_t] = SO(N,T,fobj, dim,lb,ub)
function [fval,gbest_t] = SO(fobj, dim, popsize, T,lb, ub, func_num)
%initial 
vec_flag=[1,-1];
Threshold=0.25;
Thresold2= 0.6;
...
for i=1:popsize
 fitness(i)=feval(fobj,X(i,:)', func_num);   
end
